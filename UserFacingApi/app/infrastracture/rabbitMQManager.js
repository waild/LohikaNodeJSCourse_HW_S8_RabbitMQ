...
/* var rmqManager = require('./app/libs/rabbitMQManager');


rmqManager.subscribe("hello",function(data)
{
    console.log(data);
});

setTimeout (()=>{rmqManager.publish("hello","Hello World 222")},3000);

setTimeout (()=>{rmqManager.publish("hello",{text: "Hello World 555"})},3000);
*/
